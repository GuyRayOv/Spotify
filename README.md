...
The original dataset documentation by Kaggles is available [here](data/README.md.md).
...
6. Open  [notebooks/5_spotify_models.ipynb](https://github.com/GuyRayOv/Spotify/blob/main/notebooks/5spotify_models.ipynb), for a full execution, or any notebook for a partial run.
7. Click **Run All**
